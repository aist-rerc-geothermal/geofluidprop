...
#ifndef _DRIESNER2007_H2ONACL_H_
#define _DRIESNER2007_H2ONACL_H_
...
H2O_NaCl_PhaseType driesner07_H2O_NaCl_phase_type(double p_Pa, double T_K, double x);

char* driesner07_H2O_NaCl_phase_type_to_str(H2O_NaCl_PhaseType phase, char*);
